  ...
  return (
    ...
    >
      ...
      >
        ...
        Maintenance at this stage is crucial for vehicle longevity to boost efficiency and prevent breakdowns.
        </p>
      </motion.div>
      <motion.div
        variants={variantsSecond}
      ...
      >
        <p className="text-xs text-neutral-500">Use FixMyRide</p>
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    </motion.div>
  );
...
const items = [
...

  {
    ...
    description: (
      <span className="text-sm">
        Spark plugs play a vital role in creating energy for the engine. Spark plugs that fail may cause a vehicle’s check engine light to illuminate, run rough, or have difficulty starting.
      </span>
    ),
    header: <SkeletonFive />,
    className: "md:col-span-1",
